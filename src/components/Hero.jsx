    ...
    >
      ...
      >
        ...
        <div className="flex gap-5 mt-10">
          ...
          <button className="bg-cyan-500 px-8 py-4 rounded-full hover:scale-110 duration-300">
            Download CV
          </button>

          <button className="border border-cyan-400 px-8 py-4 rounded-full hover:bg-cyan-500 duration-300">
            Contact Me
          </button>
